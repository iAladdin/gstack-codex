...
describe('CLI server script resolution', () => {
  test('prefers adjacent browse/src/server.ts for compiled project installs', () => {
    ...
    const execPath = path.join(root, '.codex/skills/gstack-codex/browse/dist/browse');
    const serverPath = path.join(root, '.codex/skills/gstack-codex/browse/src/server.ts');
