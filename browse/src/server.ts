/**
 * gstack-codex browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.gstack-codex/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.gstack-codex/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['gstack-codex browse — headless browser for AI agents', '', 'Commands:'];
